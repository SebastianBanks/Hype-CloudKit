...
extension User {
    convenience init?(ckRecord: CKRecord) {
        guard let username = ckRecord[UserStrings.usernameKey] as? String,
              ...
              let appleUserReferanceKey = ckRecord[UserStrings.appleUserReferenceKey] as? CKRecord.Reference
        else { return nil }
        ...
        self.init(username: username, bio: bio, profilePhoto: foundPhoto, recordID: ckRecord.recordID, appleUserReference: appleUserReferanceKey)
    }
}
